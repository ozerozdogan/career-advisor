        ...
        <nav className="flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex flex-col">
              <span className="text-xl font-bold text-slate-800 md:leading-tight leading-[18px]">Career Advisor</span>
              <span className="text-xs text-slate-500">Your Path to Success</span>
            </div>
          </div>
          <div className="flex items-center space-x-2 md:space-x-6">
            <a href="https://github.com/ozerozdogan" target="_blank" className="text-slate-600 hover:text-slate-900 transition-colors flex items-center space-x-1.5">
              <svg
            ...
            <a href="https://www.linkedin.com/in/ozerozdogan/" target="_blank" className="text-slate-600 hover:text-slate-900 transition-colors flex items-center space-x-1.5">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="20"
                height="20"
            ...
            >
              ...
              {isAboutOpen && (
                 <div className="absolute right-0 mt-2 w-64 bg-white border border-slate-200 rounded-lg shadow-lg p-4 z-10">
                   <h3 className="text-lg font-semibold text-slate-800 mb-2">About Career Advisor</h3>
